...
public class Model3D {
    ...
    public void parse(Renderer renderer){

        try{
            switch (MODE){
                case Model3D.LOAD_MTL_OBJ:
                    final LoaderAWD parser = new LoaderAWD(context.getResources(), renderer.getTextureManager(), resId_obj);
                    parser.parse();
                    ...
                    //material.addTexture(new Texture("Texture", R.drawable.texture));
                ...
                case LOAD_VIDEO_PLANE:
                    ...
                    videoTexture = new StreamingTexture("VideoTexture", mediaPlayer);
                    ...
                    mObject3D = new Plane(10f, 7.5f, 1, 1);
                    mObject3D.setMaterial(material);
